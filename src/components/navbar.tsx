    ...
    <div className="fixed top-0 left-0 right-0 z-20 flex items-center p-2 bg-black border-b border-gray-800">
      <div className="flex items-center space-x-2">
        <Button
          ...
          className="text-white hover:bg-gray-700 active:bg-gray-600 flex items-center transition-colors"
          data-history-toggle
      ...
      <div className="ml-auto">
        <Button
          variant="outline"
          size="sm"
          className="text-white border-gray-700 bg-transparent hover:bg-gray-700 active:bg-gray-600 transition-colors"
          aria-label="Login"
        >
          Login
        </Button>
